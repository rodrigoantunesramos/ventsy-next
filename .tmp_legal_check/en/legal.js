...
const legal = {
    termos: {
        ...
        alerta: 'By creating an account or using the VENTSY platform, you declare that you have read, understood and agreed to all the terms below. If you do not agree, do not use the service.',
        ...
        s3: {
            ...
            intro: 'To use the platform’s full features, you must create an account. When registering, the User declares that:',
            itens: [
            ...
            destaque: 'VENTSY reserves the right to refuse or cancel registrations that violate these terms or that contain false information.',
        },
        s4: {
            titulo: 'Use of the platform',
            intro: 'The User undertakes to use the platform in a lawful and ethical manner. The following is expressly prohibited:',
            itens: [
        ...
        s8: {
            ...
            intro: 'The cancellation policy for each venue is set by the Owner and displayed on the listing page. As a general rule:',
            itensTitulo: [
            ...
            destaque: 'The VENTSY service fee is non-refundable in the event of cancellation by the Renter.',
        },
        s9: {
            titulo: 'Reviews and content',
            intro: 'VENTSY allows Renters to publish reviews about venues after the event has taken place. By publishing a review, the User:',
            itens: [
        ...
        s12: {
            ...
            intro: 'VENTSY may suspend or terminate an account, at any time and without prior notice, in the following cases:',
            itens: [
    ...
    privacidade: {
        ...
        s3: {
            ...
            destaque: 'We never sell your personal data to third parties. Your data is used exclusively for the purposes described in this policy.',
        },
        s4: {
            titulo: 'Data sharing',
        ...
        s6: {
            ...
            intro: 'We adopt technical and organizational measures to protect your data against unauthorized access, alteration, disclosure or destruction, including:',
            itens: [
        ...
        s11: {
            titulo: 'Contact',
            intro: 'For questions, requests or to exercise your rights, please contact our Data Protection Officer (DPO):',
            emailLabel: 'Email:',
