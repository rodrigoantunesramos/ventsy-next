...
const legal = {
    termos: {
        ...
        alerta: 'Ao criar uma conta ou utilizar a plataforma VENTSY, você declara ter lido, compreendido e concordado com todos os termos abaixo. Caso não concorde, não utilize o serviço.',
        indiceTitulo: 'Índice',
        ...
        s3: {
            ...
            intro: 'Para utilizar as funcionalidades completas da plataforma, é necessário criar uma conta. Ao se cadastrar, o Usuário declara que:',
            itens: [
            ...
            destaque: 'A VENTSY reserva-se o direito de recusar ou cancelar cadastros que violem estes termos ou que apresentem informações falsas.',
        },
        s4: {
            titulo: 'Uso da plataforma',
            intro: 'O Usuário compromete-se a utilizar a plataforma de forma lícita e ética. É expressamente proibido:',
            itens: [
        ...
        s8: {
            ...
            intro: 'A política de cancelamento de cada espaço é definida pelo Proprietário e exibida na página do anúncio. Em regra geral:',
            // Cada item: rótulo em negrito + texto.
            itensTitulo: [
            ...
            destaque: 'A taxa de serviço da VENTSY não é reembolsável em casos de cancelamento pelo Locatário.',
        },
        s9: {
            titulo: 'Avaliações e conteúdo',
            intro: 'A VENTSY permite que Locatários publiquem avaliações sobre os espaços após a realização do evento. Ao publicar uma avaliação, o Usuário:',
            itens: [
        ...
        s12: {
            ...
            intro: 'A VENTSY pode suspender ou encerrar uma conta, a qualquer momento e sem aviso prévio, nos seguintes casos:',
            itens: [
    ...
    privacidade: {
        ...
        s3: {
            ...
            destaque: 'Nunca vendemos seus dados pessoais a terceiros. Seus dados são usados exclusivamente para os fins descritos nesta política.',
        },
        s4: {
        ...
        s6: {
            ...
            intro: 'Adotamos medidas técnicas e organizacionais para proteger seus dados contra acesso não autorizado, alteração, divulgação ou destruição, incluindo:',
            itens: [
        ...
        s11: {
            titulo: 'Contato',
            intro: 'Para dúvidas, solicitações ou exercício dos seus direitos, entre em contato com nosso Encarregado de Dados (DPO):',
        ...
        contatoSub: 'Nossa equipe está pronta para te ajudar com qualquer questão sobre privacidade.',
        contatoBtn: 'Fale conosco →',
    },
};
