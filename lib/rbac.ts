...
export const MODULOS: { key: string; label: string; grupo: string }[] = [
  ...
  { key: 'expositores', label: 'Expositores & Patrocínios', grupo: 'Operações' },
  { key: 'estacionamento', label: 'Estacionamento', grupo: 'Operações' },
  { key: 'catering', label: 'Catering & Bar', grupo: 'Operações' },
  { key: 'layouts', label: 'Layouts & Plantas', grupo: 'Operações' },
  { key: 'plano-b', label: 'Clima & Plano B', grupo: 'Operações' },
  ...
  { key: 'unidades', label: 'Unidades', grupo: 'Conta' },
