      ...
      <main className="max-w-5xl mx-auto px-5 pt-28 pb-20">
        <div className="flex items-center justify-between gap-3 mb-8 flex-wrap">
          <div>
            ...
            <p className="text-ink-muted mt-1">Acompanhe quanto você já faturou e o que tem a receber.</p>
          </div>
          <Link href="/reservas" className="bg-ink hover:bg-ink-soft text-white font-bold text-sm rounded-xl px-5 py-2.5 transition-colors">Gerenciar reservas →</Link>
        </div>
        ...
        {!authChecked || loading ? (
          ...
          <div className="rounded-2xl border border-gray-200 bg-white shadow-card p-8 text-center">
            ...
            <Link href="/meus-espacos" className="inline-block bg-brand hover:bg-brand-600 text-white font-bold rounded-xl px-6 py-3 transition-colors">Ver meus espaços</Link>
          </div>
        ) : (
          <div className="space-y-10">
            ...
            {pendentes > 0 && (
              <div className="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 flex items-center justify-between gap-3 flex-wrap">
                ...
                <Link href="/reservas" className="text-sm font-bold text-amber-900 underline">Revisar agora →</Link>
              </div>
            )}
            ...
            <section>
              ...
              <p className="text-xs text-ink-muted mt-3">
                ...
                <Link href="/reservas" className="text-brand font-semibold underline">configurar recebimentos</Link>.
              </p>
            </section>
          </div>
        )}
