...
// ─────────────────────────────────────────
import { getSession, signOut, getPerfil, getAssinatura, getPropriedade, getDados30Dias } from '(dashboard)/dashboard/js/api.js';
import { sb } from '(dashboard)/dashboard/js/api.js';
import { state, setState } from '(dashboard)/dashboard/js/state.js';
import {
    hideLoadingScreen,
    preencherUI,
    toggleAvatar,
...
import { init as initFinanceiro } from '(dashboard)/dashboard/modules/financeiro.js';
import { init as initDocumentos } from '(dashboard)/dashboard/modules/documentos.js';
import { init as initEquipe     } from '(dashboard)/dashboard/modules/equipe.js';
import { init as initCalendario } from '(dashboard)/dashboard/modules/calendario.js';
import { init as initFotos      } from '(dashboard)/dashboard/modules/fotos.js';
import { init as initMinhaPropriedade } from '(dashboard)/dashboard/modules/minhapropriedade.js';
import { init as initLeads      } from '(dashboard)/dashboard/modules/leads.js';
import { init as initPlanos } from '(dashboard)/dashboard/modules/planos.js';
import { init as initRelatorio } from '(dashboard)/dashboard/modules/relatorio.js';
import { init as initIndique } from '(dashboard)/dashboard/modules/indique.js';
import { init as initConfiguracoes } from '(dashboard)/dashboard/modules/configuracoes.js';
