...
// Átomos de UI compartilhados pelas abas de Clima & Plano B.
...
import type { CondIcone } from '@/lib/plano-b';
...
export const IcoCloud = () => svg(<path d="M17.5 19a4.5 4.5 0 0 0 0-9 6 6 0 0 0-11.6 1.5A4 4 0 0 0 6 19h11.5Z" />);
...
export const IcoRefresh = () => svg(<path d="M21 12a9 9 0 1 1-2.64-6.36M21 4v5h-5" />, 15);
export const IcoSparkle = () => svg(<path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3Z" />, 15);
export const IcoCopy = () => svg(<><rect x="9" y="9" width="11" height="11" rx="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></>, 13);
export const IcoSend = () => svg(<path d="M22 2 11 13M22 2l-7 20-4-9-9-4 20-7Z" />, 14);
export const IcoWhats = () => svg(<path d="M12 3a9 9 0 0 0-7.7 13.6L3 21l4.5-1.2A9 9 0 1 0 12 3Zm0 0" />, 14);
export const IcoList = () => svg(<path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01" />, 15);
export const IcoMegafone = () => svg(<path d="M3 11v2a1 1 0 0 0 1 1h2l5 4V6L6 10H4a1 1 0 0 0-1 1ZM16 8a5 5 0 0 1 0 8M19 5a9 9 0 0 1 0 14" />, 15);
export const IcoWind = () => svg(<path d="M3 8h11a3 3 0 1 0-3-3M3 16h13a3 3 0 1 1-3 3M3 12h18" />, 15);
export const IcoThermo = () => svg(<path d="M14 14.76V5a2 2 0 0 0-4 0v9.76a4 4 0 1 0 4 0Z" />, 14);
export const IcoSun = () => svg(<><circle cx="12" cy="12" r="4" /><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4" /></>, 14);
export const IcoSunrise = () => svg(<path d="M17 18a5 5 0 0 0-10 0M12 2v7M5.2 11.2l1.4 1.4M2 18h2M20 18h2M17.4 12.6l1.4-1.4M22 22H2M8 6l4-4 4 4" />, 14);
export const IcoChevron = () => svg(<path d="m9 18 6-6-6-6" />, 14);
export const IcoEye = () => svg(<><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z" /><circle cx="12" cy="12" r="3" /></>, 14);
...
// ── Ícone de condição do tempo (a partir do código WMO normalizado) ───────────
const COND_PATH: Record<CondIcone, ReactNode> = {
  sol: <><circle cx="12" cy="12" r="4" /><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4" /></>,
  sol_nuvem: <><path d="M7 8a4 4 0 0 1 7.7-1.5" /><path d="M3.5 5.5 4.5 6.5M8 2v1.5M1.5 9H3" /><path d="M16.5 19a3.5 3.5 0 0 0 0-7 5 5 0 0 0-9.6 1.3A3.2 3.2 0 0 0 7 19h9.5Z" /></>,
  nuvem: <path d="M17.5 19a4.5 4.5 0 0 0 0-9 6 6 0 0 0-11.6 1.5A4 4 0 0 0 6 19h11.5Z" />,
  nevoa: <path d="M3 8h14M5 12h16M3 16h14M7 20h12" />,
  chuva: <><path d="M17.5 14a4.5 4.5 0 0 0 0-9 6 6 0 0 0-11.6 1.5A4 4 0 0 0 6 14h11.5Z" /><path d="M8 18l-1 3M12 18l-1 3M16 18l-1 3" /></>,
  tempestade: <><path d="M17.5 13a4.5 4.5 0 0 0 0-9 6 6 0 0 0-11.6 1.5A4 4 0 0 0 6 13h11.5Z" /><path d="M12 12l-2 4h3l-2 4" /></>,
  neve: <><path d="M17.5 13a4.5 4.5 0 0 0 0-9 6 6 0 0 0-11.6 1.5A4 4 0 0 0 6 13h11.5Z" /><path d="M9 18h.01M13 18h.01M11 21h.01M15 21h.01" /></>,
};
export function CondIcon({ icone, size = 18 }: { icone: CondIcone; size?: number }) {
  return svg(COND_PATH[icone] || COND_PATH.nuvem, size, 1.8);
}
